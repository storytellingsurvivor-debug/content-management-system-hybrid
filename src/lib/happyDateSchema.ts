...
const DATE_COLUMNS: BlogColumnDefinition[] = [
  ...
  {
    name: "article_blog_slugs",
    label: "Article Blog Slugs",
    uiType: "stringArray",
    required: false,
    readOnly: false,
  },
  {
    name: "happy_wall_audience_slugs",
    label: "Happy Wall Audience Slugs",
    uiType: "stringArray",
    required: false,
    readOnly: false,
  },
...
const DATE_GROUPS: FieldGroup[] = [
  ...
  {
    title: "Content",
    fields: ["position", "views", "markdown_content", "structured_data"],
  },
  {
    title: "Metadata",
    fields: [
...
const CATEGORY_GROUPS: FieldGroup[] = [
  {
    title: "Identity",
    fields: ["id", "created_at", "slug", "language", "label", "is_active"],
  },
  {
    title: "Appearance",
    fields: ["emoji", "color", "title", "description", "position"],
  },
  {
    title: "Metadata",
    fields: [
...
export const HAPPY_DATE_TABLES: Record<
  "dates" | "categories",
  HappyTableConfig
> = {
  dates: {
    table: HAPPY_DATE_TABLE,
    label: "Dates",
    columns: DATE_COLUMNS,
    groups: DATE_GROUPS,
  },
  categories: {
    table: HAPPY_DATE_CATEGORY_TABLE,
    label: "Categories",
